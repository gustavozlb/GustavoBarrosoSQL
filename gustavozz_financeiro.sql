...
--
-- Banco de dados: `gustavozz_financeiro`
--
CREATE DATABASE IF NOT EXISTS `gustavozz_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gustavozz_financeiro`;
...
ELSE
SELECT'O identificado do registro não foi informado!'AS Msg;
END IF;
END$$
...
(v_nome,v_cpf);
ELSE
SELECT'Nome e CPF devem ser fornecido para o cadastro!'
AS Msg;
END IF;
END$$
...
ELSE
SELECT'O novos NOME e CPF devem ser informado!'
AS Msg;
END IF;
END$$
...
(1, 'Gustavo Zimermann Lopes Barroso', '023.456.789-10'),
(2, 'Wolverine Stark', '023.456.789-11');
